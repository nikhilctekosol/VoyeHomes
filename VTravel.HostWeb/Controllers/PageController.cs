        ...
        public IActionResult Update([FromBody] SitePage model, int id)
        {
            ...
            try
            {
                ...
                if (model != null)
                {
                    ...
                    var query = string.Format(@"UPDATE page SET title='{0}',content='{1}',meta_title='{2}',meta_description='{3}',meta_keywords='{4}' WHERE id={5}",
                                     model.title, model.content,model.metaTitle,model.metaDescription,model.metaKeywords, id);
