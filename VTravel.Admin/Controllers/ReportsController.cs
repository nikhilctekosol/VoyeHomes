    ...
    public class ReportsController : Controller
    {
        ...
        public IActionResult GetSheet(int propid, string fromdate, string todate)
        {
            ...
            try
            {
                ...
                //    "</td>               " +
                //    "<td bgcolor=\"#F1F1F1\">                   " +
                //    "<p>" + ds.Tables[0].Rows.Count + " (Not included in our calculations)</p>               " +
                //    "</td>           " +
                //    "</tr>           " +
                //    "<tr style=\"height:15pt\">               " +
                //    "<td bgcolor=\"#F1F1F1\">                   " +
                ...
                //            "<span style=\"margin-left: 20pt; font-size:16px;\"><b>" + dsproperty.Tables[2].Rows[i]["channel_name"].ToString() + "</b></span> " +
                //            "<table class=\"first\" style=\"border-collapse: collapse; margin-left: 20pt; margin-right: 20pt; width: 100%;\" cellspacing=\"0\">           " +
                //        "<tr style=\"height:31pt;\">               " +
                //        "<th bgcolor=\"#001F5F\">                   " +
                ...
                //            "<td style=\"border:1pt solid black;\">                   " +
                //            "<p style=\"text-indent: 0pt;text-align: left;\"><br /></p>                   " +
                //            "<p style=\"padding-left: 5pt;text-indent: 0pt;line-height: 12pt;text-align: left;\">" + dv.ToTable().Rows[j]["cust_name"].ToString() + "</p>               " +
                //            "</td>               " +
                //            //"<td style=\"border:1pt solid black;\">                   " +
                //            //"<p style=\"text-indent: 0pt;text-align: left;\"><br /></p>                   " +
                ...
                //            "<td style=\"border:1pt solid black;\">                   " +
                //            "<p style=\"text-indent: 0pt;text-align: left;\"><br /></p>                   " +
                //            "<p style=\"padding-right: 4pt;text-indent: 0pt;line-height: 12pt;text-align: right;\">₹" + dv.ToTable().Rows[j]["gst"].ToString() + "</p>               " +
                //            "</td>               " +
                //            "<td style=\"border:1pt solid black;\">                   " +
                //            "<p style=\"text-indent: 0pt;text-align: left;\"><br /></p>                   " +
                //            "<p style=\"padding-right: 4pt;text-indent: 0pt;line-height: 12pt;text-align: right;\">₹" + Convert.ToDecimal(dv.ToTable().Rows[j]["booking_amount"]).ToString("0.##") + "</p>               " +
                //            "</td>               " +
                //            "<td style=\"border:1pt solid black;\">                   " +
                //            "<p style=\"text-indent: 0pt;text-align: left;\"><br /></p>                   " +
                //            "<p style=\"padding-right: 4pt;text-indent: 0pt;line-height: 12pt;text-align: right;\">₹" + Convert.ToDecimal(dv.ToTable().Rows[j]["host_share"]).ToString("0.##") + "</p>               " +
                //            "</td>           " +
                //            "<td style=\"border:1pt solid black;\">                   " +
                //            "<p style=\"text-indent: 0pt;text-align: left;\"><br /></p>                   " +
                //            "<p style=\"padding-right: 4pt;text-indent: 0pt;line-height: 12pt;text-align: right;\">₹" + Convert.ToDecimal(dv.ToTable().Rows[j]["balancepayment"]).ToString("0.##") + "</p>               " +
                //            "</td>           " +
                //            "</tr>           ";
                ...
                //        "</td>               " +
                //        "<td style=\"border:1pt solid black;\" bgcolor=\"#001F5F\">                   " +
                //        "<p class=\"amount\" style=\" color: white;\">₹" + gst.ToString("0.##") + "</p>               " +
                //        "</td>               " +
                //        "<td style=\"border:1pt solid black;\" bgcolor=\"#001F5F\">                   " +
                //        "<p class=\"amount\" style=\" color: white;\">₹" + ba.ToString("0.##") + "</p>               " +
                //        "</td>               " +
                //        "<td style=\"border:1pt solid black;\" bgcolor=\"#001F5F\">                   " +
                //        "<p class=\"amount\" style=\" color: white;\">₹" + hs.ToString("0.##") + "</p>               " +
                //        "</td>           " +
                //        "<td style=\"border:1pt solid black;\" bgcolor=\"#001F5F\">                   " +
                //        "<p class=\"amount\" style=\" color: white;\">₹" + bp.ToString("0.##") + "</p>               " +
                //        "</td>           " +
                //        "</tr>       " +
                //        "</table>       ";
                //    }
                ...
                //html = html + "<p style=\"text-indent: 0pt;text-align: left;\"><br /></p>                   " +
                //        "<h4 style=\"text-align: center;\">***End of the report***</h3>           ";

                //    html = html + "<div style=\"margin-left:40pt; width:100%;\">           " +
                //    "<h2 style=\"text-align: center;\">Please feel free to call +91 - 7736699537, in case of any queries</h2>           " +
                //    "<p style=\"text-indent: 0pt;text-align: left;\"><br /></p>           " +
                //    "<p style=\"text-align: center; font-size:18px;\"><b>voye.<span class=\"s11\">in </span>Travel Automations India Private Limited</b></p>           " +
                //    "<p style=\"text-indent: 0pt;text-align: left;\"><br /></p>           " +
                //    "<p style=\"line-height: 112%;text-align: center;\">           " +
                //    "<span>Registered Office:Suite No – 346, GS2, Heavenly Plaza, Kakkanad, Kochi – 682 021, </span>           " +
                //    "| <a href=\"http://www.voyehomes.com/\" target=\"_blank\">www.voyehomes.com</a>           " +
                //    "<span>|</span><a href=\"mailto:support@voye.in\" target=\"_blank\">support@voye.in </a>           " +
                //    "| <a href=\"mailto:%7C%20voyehomes@gmail.com\" class=\"a\" target=\"_blank\"> voyehomes@gmail.com</a>           " +
                //    "<span>Mob: 9605714953 &amp; 9745430660 | KSUM, UL Cyber Park, Calicut - 673 01</span>           " +
                //    "</p>       " +
                //    "</div>      " +
                //    "</body></html>";

                //byte[] toEncodeAsBytes = System.Text.ASCIIEncoding.ASCII.GetBytes(html);
                //response.Data = System.Convert.ToBase64String(toEncodeAsBytes);
                ...
                if (dshistory.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        query1 = string.Format(@"update settlement_history set html_content = '{2}', updated_by = {3}, updated_on = '{4}', is_approved = 'N' where property_id = {0} and from_date = '{1}';"
                                                , propid, fromdate, html, userId, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
                    }
                }
                else
                {
                    query1 = string.Format(@"insert into settlement_history(property_id,from_date,to_date,html_content, is_approved, created_by, created_on) 
                                            VALUES({0},'{1}','{2}','{3}','N',{4},'{5}');", propid, fromdate, todate, html, userId, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
                }
