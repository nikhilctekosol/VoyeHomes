...
export class UsersComponent implements OnInit  {
  ...
  private loadUsers() {
    ...
    this.http.get('api/partner-user/get-list'
  ...
  openUser(userDialog: TemplateRef<any>, id) {
    ...
    this.user.userProperties = ct.userProperties;
  ...
  onNewUserSubmit() {
   ...
   // console.log(JSON.stringify(this.selectedProperties));
    ...
    this.http.post('api/partner-user/create'
  ...
  onUserSubmit() {
    ...
    this.http.put('api/partner-user/update?id=' + this.user.id
      , this.user, { headers: headers }).subscribe((res: any) => {
        this.loadingSave = false;
  ...
  deleteUser() {
    ...
    this.http.delete('api/partner-user/delete?id=' + this.user.id
      , { headers: headers }).subscribe((res: any) => {
        this.loadingSave = false;
